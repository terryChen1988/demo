...
public class TestStormAnchor {
	
	private static final Logger log = LoggerFactory.getLogger(TestStormAnchor.class);
	...
	public static void main(String[] args) {
		...
		builder.setBolt("BoltDemo", new BoltDemo(), 1).fieldsGrouping("SpoutDemo", new Fields("msg1"));//.shuffleGrouping("SpoutDemo");
